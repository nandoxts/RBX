...
print("[UserPanel] ══════════════════════════════════════")
print("[UserPanel] Server iniciado")
print("[UserPanel] Universe ID:", UNIVERSE_ID)
print("[UserPanel] Place ID:", PLACE_ID)
print("[UserPanel] Passes manuales:", #MANUAL_GAMEPASS_IDS)
print("[UserPanel] ══════════════════════════════════════")
