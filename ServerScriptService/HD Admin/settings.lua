...
return {
	...
	AppFont				= Enum.Font.SourceSans; -- You can also do "rbxasset://fonts/families/Bangers.json" or "Bangers"; 
	...
	ChartsNotice				= true;			-- The 'enable HttpService to be added to the HD Admin Charts' notice sent to the owner of the game
	...
	AutoSaveMap					= false;		 -- Should the whole game be backed up automatically on start? If false, you'll have to call :SaveMap() first before :LoadMap()
