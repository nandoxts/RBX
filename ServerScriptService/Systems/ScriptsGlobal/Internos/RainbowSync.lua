...
local CONFIG = {
	...
	paths = {
		...
		{ path = "workspace.estructura ritmo latino.EsferaGiratoria", recursive = true },
		{ path = "workspace.estructura ritmo latino.Decorativo0.Luces", recursive = true },
		{ path = "workspace.estructura ritmo latino.Decorativo1.Luces", recursive = true },
		{ path = "workspace.estructura ritmo latino.Decorativo2.Luces", recursive = true },
		{ path = "workspace.estructura ritmo latino.Decorativo3.Luces", recursive = true },
		{ path = "workspace.estructura ritmo latino.Decorativo4.Luces", recursive = true },
		{ path = "workspace.estructura ritmo latino.Decorativo5.Luces", recursive = true },
		{ path = "workspace.estructura ritmo latino.Decorativo6.Luces", recursive = true },
		{ path = "workspace.estructura ritmo latino.Decorativo7.Luces", recursive = true },
		{ path = "workspace.estructura ritmo latino.DecorativoCentral.Model1.Luces", recursive = true },
		{ path = "workspace.estructura ritmo latino.DecorativoCentral.Model2.Luces", recursive = true },
		{ path = "workspace.estructura ritmo latino.DecorativoCentral.LucesMiniCirculares", recursive = true },
